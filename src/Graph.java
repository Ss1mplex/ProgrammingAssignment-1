...
public class Graph {
    ...
    /**
     * Performs connection, union, and closure operations based on operators and operands.
     * Calls the NFA construction function based on the provided parameters.
     * When handling 'a*', it invokes the function for handling single-character closures,
     * and there is also a function for handling NFA closures.
     */
    ...
    /**
     * Handles single-character closure.
     */
